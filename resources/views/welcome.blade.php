...
<div class="row">
  <div class="col-md-12 subtitulo text-center">
    Publicidad Comestible
  </div>
</div>
<div class="row">
<div class="col-md-12">
<div id="carouselExampleIndicators" class="carousel slide album" data-ride="carousel">
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img class="d-block w-100 imagen" src="{{asset('/img/nat1.jpg')}}" alt="First slide">
    ...
    <div class="carousel-item">
      <img class="d-block w-100 imagen" src="{{asset('/img/nat2.jpg')}}" alt="Second slide">
    </div>
    <div class="carousel-item">
      <img class="d-block w-100 imagen" src="{{asset('/img/nat3.jpg')}}" alt="Third slide">
    </div>
  </div>
...
<div class="row align-items-center">
  ...
  <div class="col-md-4 text2">
    <p class="subtitulo" style="color: white">Titulo</p>
